-------------------------------------------------------------------------------
-- LoveLetter html doclet
-- Based on Luadoc's standard html doclet
--
...
local assert, getfenv, ipairs, loadstring = assert, getfenv, ipairs, loadstring;
local pairs, setfenv, tostring, tonumber = pairs, setfenv, tostring, tonumber;
local type, print = type, print;
local io = require"io"
local lfs = require "lfs"
local lp = require "luadoc.doclet.LoveLetter.html.index.lp"
local luadoc = require"luadoc"
local package = package
local string = require"string"
local table = require"table"

module "luadoc.doclet.LoveLetter.html"
...
function include (template, env)
	...
	print("DBG luadoc.doclet.LoveLetter = "..tostring(luadoc.doclet.LoveLetter));
	for i,v in pairs(luadoc.doclet.LoveLetter) do
		print("\tDBG LL: "..tostring(i).." => "..tostring(v));
	end
	print("DBG env.luadoc.doclet.LoveLetter = "..tostring(luadoc.doclet.LoveLetter));
	for i,v in pairs(luadoc.doclet.LoveLetter) do
		print("\tDBG env.LL: "..tostring(i).." => "..tostring(v));
	end
	env.luadoc = luadoc
	env.options = options
	env.print = print;
...
function start (doc)
	print("Using LoveLetter.html doclet!");
	-- Generate index file
